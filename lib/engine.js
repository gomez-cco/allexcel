...
const STOPWORDS = new Set([
  ...
  'calcular', 'calculo', 'obtener', 'lograr', 'usar', 'uso', 'datos', 'dato', 'informacion',
]);
...
const SYNONYMS = [
  ...
  { match: ['conviene un proyecto', 'conviene invertir', 'evaluar un proyecto', 'flujo de caja', 'rentabilidad de un proyecto'], boost: ['TIR', 'VNA'] },
  { match: ['resto de una division', 'residuo de una division', 'sobrante de dividir'], boost: ['RESIDUO'] },
  { match: ['desviacion estandar', 'desviación estándar', 'que tan dispersos', 'que tan dispersa', 'variabilidad de los datos'], boost: ['DESVEST'] },
  { match: ['celda esta vacia', 'celda vacía', 'esta vacia', 'está vacía', 'saber si esta vacio', 'saber si está vacío', 'campo vacio', 'campo vacío'], boost: ['ESBLANCO'] },
  { match: ['binario a decimal', 'decimal a binario', 'convertir binario', 'sistema binario', 'hexadecimal a decimal', 'decimal a hexadecimal', 'convertir hexadecimal'], boost: ['BIN.A.DEC y DEC.A.BIN', 'HEX.A.DEC y DEC.A.HEX'] },
  { match: ['eliminar duplicados', 'quitar duplicados', 'lista sin duplicados', 'valores unicos', 'valores únicos', 'quedarme solo con los distintos'], boost: ['UNICOS', 'CONTAR.SI'] },
  { match: ['traer datos de una url', 'datos de internet', 'conectar con una api', 'obtener datos de la web', 'consumir una api'], boost: ['SERVICIOWEB'] },
  { match: ['numero mas grande', 'número más grande', 'numero mas chico', 'número más chico', 'numero mayor de la lista', 'numero menor de la lista'], boost: ['MAX y MIN'] },
  { match: ['criterios externos', 'tabla de criterios', 'criterios en otra hoja', 'criterios en otra parte', 'criterios aparte'], boost: ['BDSUMA', 'BDPROMEDIO', 'BDCONTAR', 'BDMAX y BDMIN', 'BDEXTRAER'] },
];
...
const INTENT_RULES = [
  ...
  {
    anyToken: ['unir', 'juntar', 'combinar', 'concatenar'],
    anyPhrase: ['nombre', 'apellido', 'texto', 'celdas de texto', 'columnas de texto'],
    boost: ['CONCATENAR / CONCAT', 'UNIRCADENAS'],
    points: 14,
  },
];
